exports.generateChangePasswordHtml = (email, key, hidden_email) => {
...
<p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 17px; font-family: Arial, sans-serif;"><span style="text-decoration: underline;">${key}</span></span><br><strong><span style="font-size: 17px; font-family: Arial, sans-serif;">valid only 24 hours</span></strong><br><span style="font-size: 17px; font-family: Arial, sans-serif;">Enter the secret key on <span style="text-decoration: underline;"><span style="color: #000000; text-decoration: underline;"><a style="color: #000000; text-decoration: underline;" href="https://schedulemessages.com/change_password">ScheduleMessages.com/change_password</a></span></span></span><br><span style="font-size: 17px; font-family: Arial, sans-serif;">or click the address below</span></p></div>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;"><p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="text-decoration: underline; font-family: Arial, sans-serif; color: #000000; font-size: 15px;"><a style="color: #000000; text-decoration: underline;" href="https://schedulemessages.com/change_password?hidden_email=${hidden_email}&secretkey=${key}">https://schedulemessages.com/change_password?hidden_email=${hidden_email}&secretkey=${key}</a></span></p></div>
